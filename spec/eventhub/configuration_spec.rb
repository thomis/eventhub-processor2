...
RSpec.describe EventHub::Configuration do
  ...
  context "configuration file" do
    ...
    it "respond_to? behaves as expected" do
      EventHub::Configuration.load!
      expect(EventHub::Configuration.respond_to?(:hello)).to eq(false)
      expect(EventHub::Configuration.respond_to?(:server)).to eq(true)
    end
  end
